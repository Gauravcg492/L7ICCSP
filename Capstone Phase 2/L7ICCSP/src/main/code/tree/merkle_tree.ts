...
//         while ("children" in current && current.children !== undefined) {
//             if (current.children[0].currentPosition !== current.children[0].realPosition) {
//                 return current.children[0];
//             } 
//             if (current.children[1].currentPosition !== current.children[1].realPosition) {
