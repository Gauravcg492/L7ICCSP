...
function downloadFiles(auth) {
  ...
  var fileId = process.argv[2]; // Desired file id to download from  google drive

  var dest = fs.createWriteStream('./downloads/'+process.argv[3]); // file path where google drive function will save the file
